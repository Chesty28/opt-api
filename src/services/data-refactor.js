...
const orderSchema = require('../validation/validation-schema');

module.exports = async (partnerData) => {
	const validationResult = orderSchema.validate(partnerData, {
		abortEarly: false,
	});
	...
	let refactoredData = {
		...
		Shipping: {
			...
			DeliveryAddress: {
				...
				CountryCode:
					countryApi.getCode(partnerData.country) || partnerData.country,
